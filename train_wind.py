...
import argparse
import time
from AGLCN.wind.util import *
from AGLCN.wind.engine import trainer
from torch import nn
from AGLCN.wind.lib.dataloader import get_dataloader
from AGLCN.wind.lib.metrics import All_Metrics

parser = argparse.ArgumentParser()
parser.add_argument('--device', type=str, default='cuda:0', help='')
parser.add_argument('--dataset', type=str, default='wind', help='dataset')
...
parser.add_argument('--save', type=str, default='./model/wind', help='save path')
parser.add_argument('--expid', type=int, default=1, help='experiment id')
parser.add_argument('--log_file', type=str, default='./log/wind_log', help='log file')
parser.add_argument('--embed_dim', type=int, default=10, help='node dim')  # 40
parser.add_argument('--rate', type=int, default=1, help='')  # 10

parser.add_argument('--dropout_ingc', type=float, default=0.3, help='')

parser.add_argument('--eta', type=float, default=1, help='')
parser.add_argument('--gamma', type=float, default=0.0001, help='Control the Sparseness of Learning Graph Structure')
parser.add_argument('--order', type=float, default=0, help='The Weight of the Graph Loss')
parser.add_argument('--moco', type=float, default=0.99, help='Momentum Update')
...
parser.add_argument('--horizon', type=int, default=1, help='predict window length')
parser.add_argument('--tc_dropout', type=float, default=0.1, help='')
...
def main():
    ...
    engine = trainer(scaler, args.in_dim, args.horizon, args.num_nodes, args.nhid, args.dropout,
