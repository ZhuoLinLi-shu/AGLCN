...
from AGLCN.wind.lib.add_window import Add_Window_Horizon
from AGLCN.wind.lib.load_dataset import load_wind_dataset
from AGLCN.wind.lib.normalization import NScaler, MinMax01Scaler, MinMax11Scaler, StandardScaler, ColumnMinMaxScaler
...
def get_dataloader(args, normalizer='std', tod=False, dow=False, weather=False, single=True):
    # load raw st dataset
    print(args)
    data = load_wind_dataset(args.dataset)  # B, N, D
    # normalize st data
